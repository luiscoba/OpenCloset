...
public class ListaDeRentas extends AppCompatActivity {
    private MensajeSistema mensaje;
    private RentasAdaptador todasLasRentas;
    private GridView lstvTodasLasRentas;
    private List<RentasSendToServer> lstBeanRentas = new ArrayList<>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
/*
        setContentView(R.layout.activity_lista_rentas);
        ...
        lstvTodasLasCompras = findViewById(R.id.grdvRentas);
